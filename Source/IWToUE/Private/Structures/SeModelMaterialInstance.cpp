                                                                    ...
                                                                    UMaterial* OverrideMasterMaterial)
{
	...
	{
		MaterialPath = "/IWToUE/BaseMaterials/BaseMat.BaseMat";
	}
	else if (MaterialType == TEXT("Alpha"))
	{
		MaterialPath = "/IWToUE/BaseMaterials/BaseMatWithAlpha.BaseMatWithAlpha";
	}
	else if (MaterialType == TEXT("Mask"))
	{
		MaterialPath = "/IWToUE/BaseMaterials/BaseMatWithAlphaMask.BaseMatWithAlphaMask";
	}
